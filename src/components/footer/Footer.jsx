...
import QuoteModal from "../sectionContainers/sectionModals/QuoteModal";
      ...
      <div className="mt-10 flex flex-col items-center w-full lg:relative lg:pt-[10rem] lg:mt-28">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <span
              className="px-6 py-3 sm:px-8 sm:py-4 border border-white text-base sm:text-lg lg:text-xl leading-[100%] text-[#FFFFFF] font-sfpro font-bold rounded-full whitespace-nowrap hover:cursor-pointer"
